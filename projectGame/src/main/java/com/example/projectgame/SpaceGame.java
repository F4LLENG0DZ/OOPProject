...
public class SpaceGame extends Application {
    ...
    static final Image PLAYER_IMG = new Image("file:src/main/resources/images/player.png");
    ...
    final int MAX_BOMBS = 8,  MAX_SHOTS = MAX_BOMBS * 2;
    ...
    public void start(Stage stage) throws Exception {
        ...
        Timeline timeline = new Timeline(new KeyFrame(Duration.millis(1000/60), e -> run(gc)));
        ...
        stage.setTitle("Shoot down the rocket!");
        stage.show();
    ...
    public class Rocket {
        ...
        public void explode() {
            exploding = true;
            explosionStep = -1;
            //SoundEffect.PlaySound("src/main/resources/sound/retro-explode-1.mp3");
        }
    ...
    public class Shot {
        ...
        public void draw() {
            ...
            //SoundEffect.PlaySound("file:src/main/resources/sound/retro-gunshot.mp3");
        }
